...
public final class FragmentDetailsBinding implements ViewBinding {
  ...
  private FragmentDetailsBinding(@NonNull LinearLayout rootView, @NonNull Button addKeywordButton,
      @NonNull ImageView celestialImageView, @NonNull TextView descriptionTextView,
      @NonNull RecyclerView recycleView, @NonNull Button searchButton,
  ...
  public static FragmentDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDetailsBinding((LinearLayout) rootView, addKeywordButton,
          celestialImageView, descriptionTextView, recycleView, searchButton, timeAgoTextView,
