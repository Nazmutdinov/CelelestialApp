 ...
 */
public abstract class Hilt_ZoomFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ZoomFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ZoomFragment_GeneratedInjector) this.generatedComponent()).injectZoomFragment(UnsafeCasts.<ZoomFragment>unsafeCast(this));
    }
  }
