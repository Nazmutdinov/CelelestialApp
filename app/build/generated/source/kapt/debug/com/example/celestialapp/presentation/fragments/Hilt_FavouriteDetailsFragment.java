 ...
 */
public abstract class Hilt_FavouriteDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavouriteDetailsFragment() {
    super();
  }

  Hilt_FavouriteDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavouriteDetailsFragment_GeneratedInjector) this.generatedComponent()).injectFavouriteDetailsFragment(UnsafeCasts.<FavouriteDetailsFragment>unsafeCast(this));
    }
  }
