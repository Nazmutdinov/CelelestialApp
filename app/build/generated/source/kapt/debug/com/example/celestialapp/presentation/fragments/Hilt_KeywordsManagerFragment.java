 ...
 */
public abstract class Hilt_KeywordsManagerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_KeywordsManagerFragment() {
    super();
  }

  Hilt_KeywordsManagerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((KeywordsManagerFragment_GeneratedInjector) this.generatedComponent()).injectKeywordsManagerFragment(UnsafeCasts.<KeywordsManagerFragment>unsafeCast(this));
    }
  }
